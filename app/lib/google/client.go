...
func (c *CustomSearchClient) search(query url.Values) (*CustomSearchResponse, error) {
...
// SearchImage ...
func (c *CustomSearchClient) SearchImage(keyword string) (*CustomSearchResponse, error) {
	q := url.Values{}
	q.Add("q", keyword)
