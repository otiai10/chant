...
import (
	...
	_ "chant/app/chatroom"
	controllers "chant/app/controllers"
...
func main() {
	...
	revel.RegisterController((*controllers.Preview)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
					&revel.MethodArg{Name: "url", Type: reflect.TypeOf((*string)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
				},
			},
	...
	revel.RegisterController((*controllers.Room)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers.ChantSocket)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "RoomSocket",
				Args: []*revel.MethodArg{ 
